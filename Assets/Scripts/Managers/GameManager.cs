...
public class GameManager : MonoBehaviour
{
    ...
    public void RestartGame()
    {
        ...
        level = 0;
        //Restart score
        ScoreManager.score = 0; // score is a static variable         
    ...
    {        
        //Set levelText to display number of levels passed.
        string singular_or_plural = "level";
        if (level > 1)
        {
            singular_or_plural = singular_or_plural + "s";
        }
            
        levelText.text = "After " + level + " " + singular_or_plural + ", you died.";
